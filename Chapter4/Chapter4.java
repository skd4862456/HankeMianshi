...
public class Chapter4 {
    ...
    public static BigDecimal calculate(BigDecimal a, BigDecimal b, BigDecimal c, Fruit apple, Fruit strawberry, Fruit mongo) {
        ...
        BigDecimal dis100=BigDecimal.valueOf(100.0);
        BigDecimal dis10=BigDecimal.valueOf(10.0);
        BigDecimal sum=a.multiply(aPrice).add(b.multiply(bPrice)).add(c.multiply(cPrice));
        if (sum.compareTo(dis100) > 0){
//            每多100则多有10块钱的折扣
            BigDecimal discount = sum.divide(dis100,0,1).multiply(dis10);
    ...
    public static void main(String[] args){
        ...
        BigDecimal[] arrResult= new BigDecimal[]
                {BigDecimal.valueOf(98.4),BigDecimal.valueOf(47.2),BigDecimal.valueOf(1097.6),
                        BigDecimal.valueOf(678.0),BigDecimal.valueOf(121.2)};
//        新建水果对象
